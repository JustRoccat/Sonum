...
- **There is no brute-force protection** on the `api_token` check. If you expose Sonum beyond `localhost`, put it behind a reverse proxy that adds TLS and, ideally, its own access control.
